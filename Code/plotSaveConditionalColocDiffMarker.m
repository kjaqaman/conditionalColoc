function plotSaveConditionalColocDiffMarker(PtOrBlob,plotting, saveRes,pathToSave, varargin)
...
%                scatter(xScatter(green),bxs{bx}(green)','MarkerEdgeColor',[0 0.5 0],'LineWidth',0.75)
               ...
               for ml = 1:numMLs
                   ...
                   initialVal = c + 1;
                   currNumMvs = moviesPerML(ml)+c;
                   idxPerCategory = [(initialVal:currNumMvs),...
                                          (totalMovies+initialVal:totalMovies+currNumMvs),... 
                                          (2*totalMovies+initialVal:2*totalMovies+currNumMvs),...
                                          (3*totalMovies+initialVal:3*totalMovies+currNumMvs),...
                                          (4*totalMovies+initialVal:4*totalMovies+currNumMvs)];
                   
                   hold on

                   scatter(xScatter(blue(idxPerCategory))+deviations(ml),...
                       bxs{bx}(blue(idxPerCategory))',markers{ml},...
                       'MarkerEdgeColor',[0 0 1],'LineWidth',0.75)


                   scatter(xScatter(black(idxPerCategory))+deviations(ml),bxs{bx}(black(idxPerCategory))',...
                       markers{ml},'MarkerEdgeColor',[0 0 0],'LineWidth',0.75)


                   scatter(xScatter(green(idxPerCategory))+deviations(ml),bxs{bx}(green(idxPerCategory))',...
                       markers{ml},'MarkerEdgeColor',[0 0.5 0],'LineWidth',0.75)
...
%                scatter(xScatter(green),bxs{bx}(green)','MarkerEdgeColor',[0 0.5 0],'LineWidth',0.75)
               ...
               for ml = 1:numMLs
                   ...
                   scatter(xScatter(blue(idxPerCategory))+deviations(ml),bxs{bx}(blue(idxPerCategory))',...
                       markers{ml},'MarkerEdgeColor',[0 0 1],'LineWidth',0.75)
